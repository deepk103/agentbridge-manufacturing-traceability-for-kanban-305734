...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Manufacturing Traceability for Kanban"
    environment = "production"
    Name = "agentbridge-manufacturing-traceability-for-kanban"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-manufacturing-traceability-for-kanban-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-manufacturing-traceability-for-kanban"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-manufacturing-traceability-for-kanban-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-manufacturing-traceability-for-kanban-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-manufacturing-traceability-for-kanban-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-manufacturing-traceability-for-kanban-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-manufacturing-traceability-for-kanban-flow"
